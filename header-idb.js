...
window.handleIDBGoogleLogin = (response) => {
  // Decodifica o JWT do usuário
  const data = parseJwt(response.credential);
  // Exibe o nome/foto do usuário no lugar do botão de login
...
// Renderiza o botão ao carregar a página
